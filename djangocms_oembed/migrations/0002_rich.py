...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OembedRichPlugin'
        db.create_table('cmsplugin_oembedrichplugin', (
        ...
        db.send_create_signal('djangocms_oembed', ['OembedRichPlugin'])
    ...
    models = {
        ...
        'djangocms_oembed.oembedrichplugin': {
            'Meta': {'object_name': 'OembedRichPlugin', 'db_table': "'cmsplugin_oembedrichplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'data': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'html': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'oembed_url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
